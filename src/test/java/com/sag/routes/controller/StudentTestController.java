...
import org.springframework.test.context.junit4.SpringRunner;
	...
	public class StudentTestController 
	{
		...
		@Test
		public void getStudentById() throws java.lang.Exception 
		{
			
			Student student=new Student();

				Mockito.when(
						serviceI.getOrganizationById(Mockito.anyInt())).getMock();

				RequestBuilder requestBuilder = MockMvcRequestBuilders.get(
						"student/student/{id}").accept(
		...
		@Test
		public void createStudent() throws java.lang.Exception
		{
			Student student=new Student();
			...
			Mockito.when(
					serviceI.save(Mockito.any(Student.class))).getMock();
		...
		@Test
		public void getStudentUpdate() throws java.lang.Exception 
		{
			
			Student student=new Student();

			Mockito.when(
					serviceI.updateStudent(Mockito.any(Student.class))).getMock();
				RequestBuilder requestBuilder = MockMvcRequestBuilders.get(
						"/student/updatestudent").accept(
						MediaType.APPLICATION_JSON);
